...
GameMaster::GameMaster() : Node("game_master")
{
    score_ = 0;
    past_time_ = 0;
    charge_score_ = 0;
    ...
    sub_status_ = this->create_subscription<std_msgs::msg::Int32>("/judge_status", 10, std::bind(&GameMaster::status_callback, this, std::placeholders::_1));
    sub_courseout_count_ = this->create_subscription<std_msgs::msg::Int32>("/courseout_count", 10, std::bind(&GameMaster::courseout_count_callback, this, std::placeholders::_1));
    ...
    timer_ = this->create_wall_timer(std::chrono::seconds(1), std::bind(&GameMaster::timer_count_update, this));
}
...
void GameMaster::score_update_and_publish()
{
    ...
    std_msgs::msg::Int32 msg;
    score_ = past_time_ + courseout_count_ * 10 - charge_score_;
